...
if __name__ == "__main__":
   ...
   # Simulation Codename
    codename = "Calibrated-PIG5-ARDSnet" # This is a name for the folder where the output is directed
    ...
    additional_resistances = {"upstream":None,
                              ...
                              "pedley_config":{"activate":True,
                                               "expiratory_gamma":0.746357, # 0.327 original value
                                               "inspiratory_gamma":0.771360, # 0.327 original value
                                               "tolerance":1e-8,
                                               "nitmax":100}}
    ...
    signal_path = "/home1/agustin.perez/model2/signals/PIG5-ARDSnet.mat"
    mat = loadmat(signal_path)
    time = mat['time'].flatten()
    aw_pressure = mat['Paw_rdata'].flatten()/10.1972  # in kPa
    flow = mat['flow_rdata'].flatten()*1e6*(-1)
    ...
    # Tidal volume
    vt = 0.221 # L, program takes input in mm3 so it's multiplied by 10**6 

    # Constitutive model; 'ber','ma','yoshi','bir2019','rausch'
    cm = "bir2019"
    c = 2.8371 # [factor is 3.25 for VT30]
    beta = 1.075
    isotropic_prestrain = 1.02357
