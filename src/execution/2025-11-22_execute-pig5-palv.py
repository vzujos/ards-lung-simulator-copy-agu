...
def create_pressure_function(time_arr, pressure, 
    ...
    def pressure_func(t, plateau_pressure_sim, tol=1e-6):
        ...
        if t_mod < t_plateau_end:
            return plateau_measured  # Define inspiratory segment later
            # This was 'None' and caused errors; placeholder
        ...
        elif t_break2 <= t_mod <= t_cycle+tol:
...
if __name__ == "__main__":
   ...
   # Simulation Codename
    codename = "PIG5-mf-mediastinum" # This is a name for the folder where the output is directed
    ...
    path_to_mesh = "/mnt/c/Users/angus/Downloads/CORNELL-NEWGEO/PIG5/ARDSnet/medium-fine/"
    ...
    K_cw_stiffness = 0.0010
    K_d_stiffness = 0.0010
    inspiratory_gamma = 0.2958
    expiratory_gamma = 0.4342
    alveolar_pressure = 10.6448 # cmH2O

    
    # Constitutive model; 'ber','ma','yoshi','bir2019','rausch'
    cm = "bir2019"
    c_tissue = 1.7079 # [factor is 3.25 for VT30]
    ...
    ninternaldivs=[10, 50, 10, 40, 25, 60] # Funciona para pack-main
