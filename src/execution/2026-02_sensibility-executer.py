...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        default="medium-fine",
        help="Mesh resolution (default: medium-fine)"
    )
    ...
    parser.add_argument(
        ...
        default="perez",
        help="Constitutive model (default: bir2019)"
    )
...
physical_params = {2:{"bir2019":{"ctissue":1.2468, # Misfit = 0.016
                   ...
                   5:{"bir2019":{"ctissue":1.6175, # Misfit = 0.013
                                 "kcw":0.005,
                                 "kd":0.0008,
                                 "palv":10.5690,
                                 "gamma_insp":0.3173,
                                 "gamma_exp":0.4725},
                      "perez":{"ctissue":1.6175, # Misfit = 0.013
                               "kcw":0.005,
                               "kd":0.0008,
                               "palv":10.5690,
                               "gamma_insp":0.3173,
...
if __name__ == "__main__":
    ...
    path_to_mesh = root+"model2/geometries/PIG%i/ARDSnet/%s/"%(pig,mesh_type)
    ...
    for folder in ["Signals","VTK","Airways","Checkpoints"]:
        temp = output_to+folder
        if not os.path.isdir(temp):
            print(" > Creating subfolder %s"%folder)
            os.mkdir(temp)
    ...
    ninternaldivs=[10, 50, 10, 60, 35, 60] # Funciona para pack-main
    ...
    signal_path = root+'model2/signals/PIG%i-ARDSnet.npz'%(pig)
