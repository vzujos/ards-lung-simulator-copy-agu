...
if __name__ == "__main__":
   ...
   # Simulation Codename
    codename = "PIG5-medium-ma-B" # This is a name for the folder where the output is directed
    ...
    vcv_lung_gravity.execute_vcv_simulation(args)
