...
if __name__ == "__main__":
   ...
   # Simulation Codename
    codename = "PIG5-medium-birzle-B" # This is a name for the folder where the output is directed
    ...
    cm = "bir2019"
    c = 2.0923 # [factor is 3.25 for VT30]
    ...
    ninternaldivs=[5, 50,10, 40, 25, 60] # Funciona para pack-main
