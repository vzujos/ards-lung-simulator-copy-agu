...
if __name__ == "__main__":
   ...
   # Simulation Codename
    codename = "PIG5-preload-grav-mc" # This is a name for the folder where the output is directed
    ...
    path_to_mesh = "/mnt/c/Users/angus/Downloads/CORNELL-NEWGEO/PIG5/ARDSnet/medium-coarse/"
    ...
    K_cw_stiffness = 0.0023
    K_d_stiffness = 0.0058
    inspiratory_gamma = 0.2944
    expiratory_gamma = 0.4476
    
    # Constitutive model; 'ber','ma','yoshi','bir2019','rausch'
    cm = "bir2019"
    c = 1.00 # [factor is 3.25 for VT30]
    stiffness_file = None #"c_tissue.xml.gz"
    beta = 1.075
    isotropic_prestrain = 1.0357
